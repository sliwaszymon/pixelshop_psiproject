text = "Lorem Ipsum jest tekstem stosowanym jako przykładowy wypełniacz w przemyśle poligraficznym. Został po raz " \
       ...
       "osobistych, jak Aldus PageMakerŁ"
...
print("W tekscie litera " + litera_1 + " wystepuje " + str(text.count(litera_1)))
print("W tekscie litera " + litera_2 + " wystepuje " + str(text.count(litera_2)))